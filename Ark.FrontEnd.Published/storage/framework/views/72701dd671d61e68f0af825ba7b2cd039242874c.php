...
<script src="<?php echo e(asset('frontend/js/lazysizes.min.js')); ?>" async=""></script>
        ...
        if($('#option-choice-form input[name=quantity]').val() > 0 && checkAddToCartValidity()){
            $.ajax({
               ...
               success: function(data){
                   ...
                   $('#unit_price').html('<strong>' + data.unit_price + '</strong>');
...
<?php /**PATH C:\Projects\Published\Release.Ark\Ark.FrontEnd.Published\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>