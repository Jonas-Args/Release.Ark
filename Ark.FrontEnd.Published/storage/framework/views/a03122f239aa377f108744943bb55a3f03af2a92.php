                                            ...
                                            <tr class="cart-item">
                                                ...
                                                <td class="product-quantity d-none d-md-table-cell">
                                                    <div class="input-group input-group--style-2 pr-4" style="width: 130px;">
														...
														<input type="text" name="quantity[<?php echo e($key); ?>]" class="form-control input-number" style="padding-left:0px; padding-right:0px" placeholder="1" value="<?php echo e($cartItem['quantity']); ?>" min="1" max="50" onchange="updateQuantity(<?php echo e($key); ?>, this)" oninput="updateQuantity(<?php echo e($key); ?>, this)" />
                                                        <span class="input-group-btn">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projects\Published\Release.Ark\Ark.FrontEnd.Published\resources\views/frontend/view_cart.blade.php ENDPATH**/ ?>