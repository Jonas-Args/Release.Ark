                                    ...
                                    <ul class="inline-links">
                                        ...
                                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(\App\Brand::find($id) != null): ?>
                                                <li><a href="<?php echo e(route('products.brand', \App\Brand::find($id)->slug)); ?>"><img src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(asset(\App\Brand::find($id)->logo)); ?>" alt="<?php echo e(\App\Brand::find($id)->name); ?>" class="img-fluid lazyload"></a></li>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projects\Published\Release.Ark\Ark.FrontEnd.Published\resources\views/frontend/product_listing.blade.php ENDPATH**/ ?>