...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(__('Conversation Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(__('Guest Checkout Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(__('Category-based Commission')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    After activate this option Seller commision will be disabled and You need to set commission on each category otherwise Admin will not get any commision. <a href="<?php echo e(route('categories.index')); ?>">Set Commisssion Now</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projects\Published\Release.Ark\Ark.FrontEnd.Published\resources\views/business_settings/activation.blade.php ENDPATH**/ ?>