	...
	<div class="col-md-12">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<h1 style="margin:-25px 0px 20px 0px;"><?php echo e(__('Send Balance')); ?></h1>
			...
			<div class="panel-body">
				...
				<div style="font-size:14px!important">
					...
					<p style="color:#808080">
						Source Wallet:
						<span style="float:right;">
							<b style="color:black"><?php echo e(__('Ark Cash')); ?></b>
						</span>
					</p>
				</div>
			...
			<div class="panel-body">
				...
				<div class="btn-group dropdown" style="float:right">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<li>
							<a href="<?php echo e(route('customers.edit', $customer->Uid)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projects\Published\Release.Ark\Ark.FrontEnd.Published\resources\views/customers/wallet_send.blade.php ENDPATH**/ ?>