                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker" data-live-search="true" name="country">
                                                        <?php $__currentLoopData = \App\Country::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($country->name); ?>" <?php if($country->code == $user->country): ?> selected <?php endif; ?>><?php echo e($country->name); ?></option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="number" min="0" class="form-control" value="<?php echo e($user->postal_code); ?>" name="postal_code" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projects\Published\Release.Ark\Ark.FrontEnd.Published\resources\views/frontend/shipping_info.blade.php ENDPATH**/ ?>