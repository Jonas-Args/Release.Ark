				...
				<div class="tab-base tab-stacked-left">
				    ...
				    <div class="tab-content">
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							...
							<div class="form-group">
								<div class="col-lg-2">
									<button type="button" class="btn btn-info" onclick="add_more_price_choice_option()"><?php echo e(__('Add more price choice option')); ?></button>
								</div>
							</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projects\Published\Release.Ark\Ark.FrontEnd.Published\resources\views/products/edit.blade.php ENDPATH**/ ?>