						...
						<div class="product-description-wrapper">
							...
							<div class="row align-items-center my-1">
								<div class="col-6">
									...
									<div class="rating">
										...
										<span class="rating-count ml-1" style="top:0;">(<?php echo e($total); ?> <?php echo e(__('customer reviews')); ?>)</span>
									</div>
								</div>
									...
									<div class="col-10">
										<div class="product-quantity d-flex align-items-center">
											<div class="input-group input-group--style-2 pr-3" style="width: 160px;">
												...
												<input type="text" name="quantity" class="form-control input-number text-center" placeholder="1" value="1" min="1" max="20">
												<span class="input-group-btn">
							...
							<div class="d-table width-100 mt-3">
								<div class="d-table-cell">
									...
									<button type="button" class="btn pl-0 btn-link strong-700"  onclick="addToWishList(<?php echo e($product->id); ?>)">
										<i class="la la-heart-o" style="font-size: large; margin-left:12px"></i>
									</button>
									<?php else: ?>
							...
							<div class="d-table width-100 mt-3">
								<div class="d-table-cell">
									...
									<!-- <button type="button" class="btn pl-0 btn-link strong-700" onclick="addToWishList(<?php echo e($product->id); ?>)">
										<i class="la la-heart-o" style="font-size: large"></i>
									</button>
								...
								<div class="clearfix">
									<div class="product-image float-left">
										<a href="<?php echo e(route('product', $top_product->slug)); ?>">
											<img class="img-fit lazyload" src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(asset($top_product->thumbnail_img)); ?>" alt="<?php echo e(__($top_product->name)); ?>">
										</a>
									</div>
										...
										<div class="col-5">
											<div class="position-relative overflow-hidden h-100">
												<a href="<?php echo e(route('product', $related_product->slug)); ?>" class="d-block product-image h-100 text-center">
													<img class="img-fit lazyload" src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(asset($related_product->thumbnail_img)); ?>" alt="<?php echo e(__($related_product->name)); ?>">
												</a>
		...
		<div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
			<div class="modal-content position-relative">
				<div class="modal-header">
					<h5 class="modal-title strong-600 heading-5"><?php echo e(__('Any question about this product?')); ?></h5>
				...
				<form class="" action="<?php echo e(route('conversations.store')); ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="modal-body gry-bg px-3 pt-3">
						<div class="form-group">
							<input type="text" class="form-control mb-3" name="title" value="<?php echo e($product->name); ?>" placeholder="Product Name" required>
						</div>
						<div class="form-group">
							<textarea class="form-control" rows="8" name="message" required placeholder="Your Question"><?php echo e(route('product', $product->slug)); ?></textarea>
						</div>
					</div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projects\Published\Release.Ark\Ark.FrontEnd.Published\resources\views/frontend/product_details.blade.php ENDPATH**/ ?>