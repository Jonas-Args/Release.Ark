                    ...
                    <div class="card">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <!-- <label>{{ __('') }}</label> -->
                                                    <div class="input-group input-group--style-1">
                                                        <input type="number" class="form-control{{ $errors->has('mobileNo') ? ' is-invalid' : '' }}" value="{{ old('mobileNo') }}" placeholder="{{ __('Phone Number') }}" name="mobileNo"/>
                                                        <span class="input-group-addon">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group--style-1">
                                                        <input type="text" class="form-control{{ $errors->has('special_code') ? ' is-invalid' : '' }}" value="{{ old('special_code') }}" placeholder="{{ __('Discount Code (Optional)') }}" name="special_code" />
                                                        <span class="input-group-addon">
                                                            <i class="text-md la la-lock"></i>
                                                        </span>
                                                        @if ($errors->has('source_code'))
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="checkbox pad-btm text-left">
                                                    ...
                                                    <label for="checkboxExample_1a" class="text-sm">
                        ...
                        <div class="text-center px-35 pb-3">
                            <p class="text-md">
                                ...
                                <a href="{{ route('user.login') }}" class="strong-600">{{__('Log In')}}</a>
                            </p>
                        </div>
                    </div>
                </div>
