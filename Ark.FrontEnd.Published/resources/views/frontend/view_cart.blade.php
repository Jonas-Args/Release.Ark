                                            ...
                                            <tr class="cart-item">
                                                ...
                                                <td class="product-quantity d-none d-md-table-cell">
                                                    <div class="input-group input-group--style-2 pr-4" style="width: 130px;">
														...
														<input type="text" name="quantity[{{ $key }}]" class="form-control input-number" style="padding-left:0px; padding-right:0px" placeholder="1" value="{{ $cartItem['quantity'] }}" min="1" max="50" onchange="updateQuantity({{ $key }}, this)" oninput="updateQuantity({{ $key }}, this)" />
                                                        <span class="input-group-btn">
